		...
		return [
			{
				...
				practicas_sustentables: JSON.parse(
					granja.practicas_sustentables
				),
				...
				<div className="w-full h-full p-3 flex flex-col justify-start items-center">
					...
					<div className="h-[85%] py-3 w-full">
						<div className="w-full h-full overflow-y-auto">
							<div className="gap-4 flex flex-col">
								{allFarms.map(
									(farm: FormattedGranja, idx: number) => (
										<FarmCard
											key={idx}
					...
					<div className="w-full flex justify-end items-center">
						<div className="flex items-center gap-4">
							...
							/>
							<div className="font-light font-inter select-none">
								{page}
							</div>
							<IoIosArrowForward
								className="text-xl hover:scale-110 tr cursor-pointer"
